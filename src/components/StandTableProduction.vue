          ...
          <div class="card shadow-lg border-0" style="border-radius: 20px; overflow: hidden;">
            ...
            <div class="card-header text-white text-center py-5" style="background: linear-gradient(135deg, #2d5a27, #4a7d3a);">
              <h1 class="display-6 fw-bold mb-2">
                <i class="bi bi-tree-fill me-2"></i>Stand Table Production
              </h1>
              <p class="lead mb-0">Diameter class breakdown of production by species group</p>
            ...
            <div class="card-body p-4">
              ...
              <div v-if="loading" class="text-center py-5">
                ...
                <p class="mt-3 text-muted">Loading data for Stand Table Production {{ selectedRegime }}...</p>
              </div>
...
export default {
  ...
  methods: {
    async fetchData() {
      ...
      try {
        const res = await fetch(`http://localhost:5000/api/stand-table-production?regime=${this.selectedRegime}`);
