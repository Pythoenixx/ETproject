          ...
          <div class="card shadow-lg border-0" style="border-radius: 20px; overflow: hidden;">
            ...
            <div class="card-header text-white text-center py-5" style="background: linear-gradient(135deg, #2d5a27, #4a7d3a);">
              <h1 class="display-5 fw-bold mb-3">
                <i class="bi bi-tree-fill me-3"></i>Stand Table Production (30 Years)
              </h1>
              <p class="lead mb-0">Detailed stand production based on diameter classes and species groups</p>
            ...
            <div class="card-body p-5">
              ...
              <div v-if="loading" class="text-center py-5">
                ...
                <p class="mt-3 text-muted">Fetching production data for regime {{ selectedRegime }}...</p>
              </div>
...
export default {
  ...
  methods: {
    async fetchData() {
      ...
      this.error = null;
      try {
        const response = await fetch(`http://localhost:5000/api/stand-table-production30?regime=${this.selectedRegime}`);
